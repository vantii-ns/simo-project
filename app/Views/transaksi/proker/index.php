            ...
            <tbody>
                <?php foreach ($proker as $p) : ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($p['WAKTU_PELAKSANAAN'] ?? '-') ?></td>
                ...
                <?php foreach ($proker as $p): ?>
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 14px 16px; vertical-align: middle;">
                            ...
                            <div style="font-size: 0.72rem; color: var(--text-muted); margin-top: 2px;"><?= $p['NAMA_DEPARTEMEN'] ?></div>
                        </td>
                        <?php 
                        ...
                        ?>
                            <td style="padding: 8px 4px; text-align: center; border-left: 1px solid #f1f5f9; vertical-align: middle;">
                                <?php if ($active): ?>
                                    <div class="gantt-bar <?= $colorClass ?>" style="height: 20px; border-radius: 10px;" title="<?= $p['WAKTU_PELAKSANAAN'] ?>"></div>
                                <?php endif; ?>
                            </td>
                        <?php endfor; ?>
                    </tr>
